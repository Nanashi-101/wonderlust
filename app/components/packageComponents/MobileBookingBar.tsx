...
export default function MobileBookingBar({ packageId, price, duration }: MobileBookingBarProps) {
  return (
    <motion.div
      initial={{ y: 100 }}
      animate={{ y: 0 }}
    ...
    >
      ...
      <BookNowButton packageId={packageId} className="rounded-full px-8 bg-cyan-600 hover:bg-cyan-500 font-bold">
        Book Now
      </BookNowButton>
    </motion.div>
  );
